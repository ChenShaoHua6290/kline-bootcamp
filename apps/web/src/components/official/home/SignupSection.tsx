...
export function SignupSection() {
  ...
  return (
    <section id="pricing" className="mx-auto max-w-[1400px] scroll-mt-24 px-4 pb-20 sm:px-6 sm:pb-28 lg:pb-36">
      <div className="rounded-3xl border border-cyan-300/22 bg-[linear-gradient(160deg,rgba(15,23,42,0.86),rgba(8,47,73,0.36))] p-3 shadow-[0_24px_58px_rgba(2,6,23,0.5)] sm:p-5 lg:p-6">
        <div id="signup" className="scroll-mt-24" />
        <div className="grid gap-5 rounded-2xl border border-cyan-300/25 bg-slate-900/45 p-4 sm:rounded-3xl sm:p-5 lg:grid-cols-[1.4fr_auto] lg:items-start lg:gap-6">
          <div>
            <h2 className="text-[25px] font-semibold leading-tight tracking-[-0.02em] text-slate-100 sm:text-[32px] lg:text-[38px]">我要报名</h2>
            <p className="mt-4 max-w-3xl text-[15px] leading-7 text-slate-300 sm:text-base sm:leading-8">
              为了减少不必要沟通，建议先查看体系中心中的服务介绍、学习流程、价格与常见问题。
            </p>
            <p className="mt-3 max-w-3xl text-[15px] leading-7 text-slate-300 sm:text-base sm:leading-8">
          ...
          <div className="w-full justify-self-center lg:w-auto lg:justify-self-end">
            <div className="rounded-2xl border border-cyan-300/28 bg-[linear-gradient(145deg,rgba(15,23,42,0.85),rgba(30,58,138,0.2))] p-3 shadow-[0_14px_30px_rgba(2,6,23,0.35)] backdrop-blur-sm">
              <div className="mx-auto w-fit rounded-xl bg-white p-2">
                <img src={wechatQr} alt="微信二维码" className="h-36 w-36 rounded-md object-cover sm:h-32 sm:w-32" />
              </div>
