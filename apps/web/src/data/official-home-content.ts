...
export const homeFaqs = [
  ...
  ['完整体系学习费用怎么安排？', '使用K线训练系统：3天免费体验、月卡49、季卡109、年卡389，内部用户永久免费使用。\n\n完整交易体系目前特惠价6899元，统一不议价，包含课件、视频、指标、共振消息提醒与K线训练系统。\n后续以最新价格为准，100%会涨价，并且只涨不降，服务内容也会不断更新，早学习，早受益。详情添加下面联系方式咨询。\n完整交易体系费用为一次永久付费的，包含上面中所有描述的服务和后面的升级、学习资料，没有二次付费的内容。'],
